...
const Cart = ({cartList,creditHour,totalPrice,remaining}) => {
    return (
        <div className="w-full border-2 bg-white h-auto p-10 lg:p-4 m-1 rounded-lg">
            <div className="border-b-2 pb-4">
            <h1 className="text-lg text-center font-bold text-[#2F80ED]">Credit Hour Remaining {remaining} hr</h1>
            </div>
            <div className="mt-4 mb-5 pb-4 border-b-2">
